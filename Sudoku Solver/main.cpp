/*
 * Sudoku Solver
 * Objective - It takes in Sudoku puzzles and outputs the solution.
*/
...
/**
  *	Here, we call the data structure 'Sudoku Frame' which holds and manupulates the values in a sudoku puzzle.
*/
class SudokuFrame{
	...
	*/
	private:void readFrameValuesFile(){
		...
		//should have a line which lets us check the frame for any errors
...
class Possibilities{
	...
	/**
	  *	@desc This constructor initializes the head (or sentinel) node.
	  *	@param none
	*/
